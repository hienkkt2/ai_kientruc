...
export const InteriorPanel: React.FC<any> = ({
    ...
    imageSize, setImageSize, handleConvertToWatercolor, isLoading
}) => {
    const { language, t } = useLanguage();
    const { theme } = useTheme();
    // FIX: Cast to any to resolve Property 'constants' does not exist error
    const {
        predefinedReferenceImages, interiorRoomTypes, interiorStyles, interiorLighting, ASPECT_RATIO_LABELS

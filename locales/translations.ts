...
export const translations = {
    vi: {
        appTitle: "AI Architecture",
        apiKeyPlaceholder: "Dán API Key của bạn tại đây...",
        saveApiKey: "Lưu",
        apiKeySaved: "Đã lưu API Key!",
        apiKeyCleared: "Đã xóa API Key!",
        selectApiKey: "Thiết lập API Key",
        alertApiKeyUtilUnavailable: "Công cụ chọn API không khả dụng.",
        developedBy: "Phát triển bởi Đình Hiển",
        sponsoredBy: "Đồng hành bảo trợ phát triển Công ty Nhà Mới Đẹp",
        apiVersionWarning: "Phiên bản này cần có API của google để hoạt động xem hướng dẫn bên phải",
        changeLanguage: "Thay đổi ngôn ngữ",
        welcomeHeader: "AI ARCHITECTURE",
        ...
        loadingUsageLimit: "Giới hạn sử dụng AI Architecture:",
        ...
        loadingAdText: "cài đặt công cụ liên hệ Đình Hiển - 0943304685",
...
Kết quả: 01 ảnh texture vuông chất lượng cao, seamless và delighting.`,
    ...
    en: {
        ...
        selectApiKey: "Setup API Key",
        alertApiKeyUtilUnavailable: "API selection tool is unavailable.",
        developedBy: "Developed by Đình Hiển",
        sponsoredBy: "Development sponsored by Nha Moi Dep Company",
        ...
        loadingUsageLimit: "AI Architecture Usage Limit:",
        ...
        loadingAdText: "Install the tool, contact Đình Hiển - 0943304685",
